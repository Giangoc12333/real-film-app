    ...
    private void btnPlayOnclick(String value) {
        btn_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<ApiResponse> call = movieService.addHistory(movieId);
                call.enqueue(new Callback<ApiResponse>() {
                    @Override
                    public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                ...
                Call<ApiResponse> hass = movieService.increaseViewMove(movieId);

                hass.enqueue(new Callback<ApiResponse>() {
                    @Override
                    public void onResponse(Call<ApiResponse> hass, Response<ApiResponse> response) {

                    }

                    @Override
                    public void onFailure(Call<ApiResponse> hass, Throwable t) {
